...
export const ChatItem = ({
  ...
  const isOwner = currentMember.id === memeber.id;
          ...
          {isPDF && (
            <div className="relative flex items-center p-2 mt--2 rounded-md bg-background/10">
              ...
              <a
                ...
                className="ml-2 mr-2 text-sm -text-indigo-500 dark:text-indigo-400 hover:underline"
              >
                PDF File
              </a>
            </div>
                    ...
                    <FormItem className="flex-1">
                      <FormControl>
                        <div className="relative w-full">
                          <Input
                            disabled={isLoading}
                            className="p-2 bg-zinc-200/90 dark:bg-zinc-700/75 border-none focus-visible:ring-0 focus-within:ring-offset-0 text-zinc-600 dark:dark:text-zinc-200 "
